...
import { Wallet, TrendingUp, Layers, Calendar, BarChart2, Award } from "lucide-react";
...
export const StatsCards: React.FC<StatsCardsProps> = ({
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-3 md:gap-4">
      ...
      {/* 2. PNL HOJE */}
      <div className="glass-panel rounded-2xl p-4 md:p-5 flex flex-col justify-between border-t-2 border-t-emerald-500/50">
        <div className="flex items-center justify-between text-slate-400 mb-2">
        ...
        <div>
          ...
          <span className="inline-block px-1.5 py-0.5 mt-0.5 rounded text-[10px] font-bold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
      ...
      {/* 3. PNL ABERTO */}
      <div className="glass-panel rounded-2xl p-4 md:p-5 flex flex-col justify-between border-t-2 border-t-cyan-400/50">
        <div className="flex items-center justify-between text-slate-400 mb-2">
